package com.groupeisi.day.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.groupeisi.day.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.groupeisi.day.security.DomainUserDetailsService", "createSpringSecurityUser");
